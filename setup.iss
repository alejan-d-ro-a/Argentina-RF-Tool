...
DefaultDirName={localappdata}\Programs\Argentina RF Tool
...
OutputBaseFilename=Instalar_Argentina RF Tool
...
[Run]
Filename: "{app}\Argentina RF Tool.exe"; Description: "{cm:LaunchProgram,Argentina RF Tool}"; Flags: nowait postinstall skipifsilent